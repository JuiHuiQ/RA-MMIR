...
for pi, path in enumerate(paths):                                                   # path index; 路径索引;
    print('path %d/%d: %s' % (pi, len(paths), path))                                # 依次载入训练权重;
